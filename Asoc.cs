...
namespace XO2
{
    public partial class Asoc : Form, IGame
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (s.Text != A[int.Parse(s.Tag.ToString())])
            {
                s.Text = A[int.Parse(s.Tag.ToString())];
                scoreA--;
                dis(false, true, true);
            }
        }
        ...
        {
            Button s = (Button)sender;
            if (s.Text != B[int.Parse(s.Tag.ToString())])
            {
                s.Text = B[int.Parse(s.Tag.ToString())];
                scoreB--;
                dis(false, true, true);
            }
        }
        ...
        {
            Button s = (Button)sender;
            if (s.Text != C[int.Parse(s.Tag.ToString())])
            {
                s.Text = C[int.Parse(s.Tag.ToString())];
                scoreC--;
                dis(false, true, true);
            }
        }
        ...
        {
            Button s = (Button)sender;
            if (s.Text != D[int.Parse(s.Tag.ToString())])
            {
                s.Text = D[int.Parse(s.Tag.ToString())];
                scoreD--;
                dis(false, true, true);
            }
        }
        ...
        private void button11_Click(object sender, EventArgs e)
        {
            ...
            if (s.Text == "???")
            {
                button9_Click((object)button9, new EventArgs());
                button10_Click((object)button10, new EventArgs());
                button12_Click((object)button12, new EventArgs());
                button13_Click((object)button13, new EventArgs());
                s.Text = F;
